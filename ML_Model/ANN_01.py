...
# constants
num_sats = 500000  # num satellites to simulate
sample_num = 20  # num recordings per satellite
...
mid_layers = 10 # number of hidden layers
mid_layer_width = 128 # width of each hidden layer
...
np.save("data/ANN_01_temp.npy", all_data)

# # S2
# x_full, y_full = np.load("data/ANN_01_temp.npy")
